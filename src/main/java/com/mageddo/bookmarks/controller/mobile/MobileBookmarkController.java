...
public class MobileBookmarkController {
	...
	public MobileBookmarkController(
		SettingsService settingsService, BookmarksService bookmarksService, TagService tagService
	) {
	...
	public HttpResponse _1(){
		return ok(mapOf(
			"mobileMaxHeight", settingsService.findSetting(MOBILE_CODE_BLOCK_MAX_HEIGHT.name()).getValue(),
